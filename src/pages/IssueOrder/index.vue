          ...
          <v-expansion-panel>
            ...
            <v-expansion-panel-content>
              <div class="delivery-method">
                ...
                >По г.Минску доставка не осуществляется. Возможен только самовывоз.</div>
                <v-radio-group v-model="shipping" column>
                  <v-radio label="Самовывоз" color="black" value="pickup"></v-radio>
                  <v-radio label="Транспортной компанией" color="black" value="transportCompany"></v-radio>
                </v-radio-group>
                <div :style="{marginBottom: '30px'}">
                  ...
                  <br />2. Оформлена отдельным актом выполненных работ, который будет передаваться "Покупателю"
